                     ...
                     <div className="dropdown-parent-wrapper">
                        <div className="dropdown-wrapper dropdown-wrapper--large">
                           <ul className="list-settings">
                              <li className="d-flex">
                                 <div className="me-3"><img src="img/mail.png" alt=""/></div>
                              ...
                              <li className="d-flex">
                                 <div className="me-3"><img src="img/color-palette.png" alt=""/></div>
                                 <div className="flex-grow-1">
                                    <h6>
                              ...
                              <li className="d-flex">
                                 <div className="me-3"><img src="img/home.png" alt=""/></div>
                                 <div className="flex-grow-1">
                                    <h6>
                              ...
                              <li className="d-flex">
                                 <div className="me-3"><img src="img/video-camera.png" alt=""/></div>
                                 <div className="flex-grow-1">
                                    <h6>
